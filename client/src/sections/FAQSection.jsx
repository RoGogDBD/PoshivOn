...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Quick — быстрый расчёт по базовым параметрам для коммерческого. Masterpiece — детальная калькуляция себестоимости с AI-оценкой сегмента рынка.",
  },
  {
      ...
      <div className="container faq-grid">
        <div>
          ...
          <p className="section-lede" style={{ marginTop: 20 }}>
            Не нашли ответ — напишите нам на support@poshivon.ru, отвечаем в течение рабочего дня.
          </p>
        </div>
