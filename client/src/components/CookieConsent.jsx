  ...
  return (
    <div className="cookie-consent" role="region" aria-label="Уведомление об использовании cookie">
      <p className="cookie-consent__text">
        Сайт использует cookie для входа и обрабатывает данные Яндекс-авторизации в
        соответствии с законодательством РФ. Подробнее —{" "}
        <a href="/privacy">в политике конфиденциальности</a>.
      </p>
